...
| P2 | PARTIAL | JavaScript typecheck reports 168 inference/declaration errors after the Vite declaration adjustment; lint and production build are the release gates. |
...
## Resolved Release Controls

- Historical Mapbox credential: **RESOLVED**, revocation owner-confirmed; current Leaflet/OpenStreetMap implementation has no dependency on it.
- Repository reproducibility: **RESOLVED** by clean checkout and verification of commit `ca0661690f0a36ca5b5597db7140426f7ff52853`.
